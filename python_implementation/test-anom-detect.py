...
# REMEMBER to set these variables locally using the following bash commands: 
...
data_location = "/home/codespace/workspace/AnomalyDetector/example-data/request-data.json"
# </vars>
